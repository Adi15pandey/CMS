  ...
  Future<void> _fetchTasks() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Map<String, dynamic>> lowTasks = List<Map<String, dynamic>>.from(data['lowTasks'] ?? []);
        List<Map<String, dynamic>> mediumTasks = List<Map<String, dynamic>>.from(data['mediumTasks'] ?? []);
        List<Map<String, dynamic>> highTasks = List<Map<String, dynamic>>.from(data['highTasks'] ?? []);
              ...
              Column(
                children: tasks
                  ...
                  child: ListTile(
                    ...
                    trailing: task['attachments'] != null
                        ? IconButton(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              const Text("CNR Number", style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              TextField(
