...
class subcasesconDetailsScreen extends StatefulWidget {
  final String caseNumber;

  subcasesconDetailsScreen({required this.caseNumber});

  @override
  _subcasesconDetailsScreenState createState() => _subcasesconDetailsScreenState();
}

class _subcasesconDetailsScreenState extends State<subcasesconDetailsScreen> {
  bool isLoading = true;
  String errorMessage = '';
  ...
  Future<void> fetchCaseData() async {
    final url = '${GlobalService.baseUrl}/api/consumer-court/case/get-consumer-court-cases/${widget.caseNumber}';
    final headers = {
      'token': '$token',
